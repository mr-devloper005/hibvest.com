...
const inputClass = 'h-12 rounded-xl border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#161a3f] outline-none transition placeholder:text-[#6f7688] focus:border-[#12156f] focus:bg-white'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-xl bg-[var(--slot4-accent-fill,#ffb52e)] px-6 text-sm font-black uppercase tracking-[0.14em] text-[#111111] shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
