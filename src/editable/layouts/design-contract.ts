...
export const editableRootStyle = {
  '--slot4-page-bg': '#f7f8fc',
  '--slot4-page-text': '#12156f',
  '--slot4-panel-bg': '#eef2f7',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#545b70',
  '--slot4-soft-muted-text': '#6f7688',
  '--slot4-accent': '#ffb52e',
  '--slot4-accent-fill': '#ffb52e',
  '--slot4-accent-soft': '#fff3cf',
  '--slot4-dark-bg': '#12156f',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e8ecf4',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f7f8fc',
  '--slot4-lavender': '#eef2f7',
  '--slot4-gray': '#f9fafc',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #f7f8fc 46%, #eef2f7 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-extrabold leading-[1.08] tracking-tight sm:text-5xl lg:text-[3.45rem]',
  ...
  button: {
    primary: `inline-flex items-center justify-center rounded-xl ${editablePalette.darkBg} px-8 py-3.5 text-sm font-semibold text-white transition hover:opacity-90`,
    ...
    accent: `inline-flex items-center justify-center rounded-xl ${editablePalette.accentBg} px-8 py-3.5 text-sm font-semibold text-[#111111] transition hover:opacity-90`,
  },
  media: {
